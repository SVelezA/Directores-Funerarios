...
app.config['MYSQL_USER'] = 'Santiago'
app.config['MYSQL_PASSWORD'] = 'titano85'
app.config['MYSQL_DB'] = 'Funeraria'
mysql = MySQL(app)
...
def CheckLogin():
    if request.method == "POST":
        ...
        check = cur.execute(""" SELECT EXISTS(SELECT * FROM credenciales WHERE Usuario = '{}' && Contraseña = '{}')""")
        if check == 1:
            print("Entró")
...
def DisplayOb():
    ...
    return render_template('tabla_obituarios.html', contacts= data)
